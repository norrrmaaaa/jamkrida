					...
					<ul class="nav" id="side-menu">
						...
						<ul class="nav nav-second-level">
							...
							if ($pagedesc == "Kredit Barang/Jasa") {
								...
								echo '<li><a href="karyawan.php">Kredit Barang/Jasa</a></li>';
							}
							?>
						</ul>
						<ul class="nav nav-second-level">
							<?php
							if ($pagedesc == "Kredit Multiguna") {
								echo '<li><a href="karyawan.php" class="active">Kredit Multiguna</a></li>';
							} else {
								echo '<li><a href="karyawan.php">Kredit Multiguna</a></li>';
							}
							?>
						</ul>
						<!-- /.nav-second-level -->
