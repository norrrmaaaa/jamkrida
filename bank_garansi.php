									...
									<tbody>
										<?php
											...
											while($data = mysqli_fetch_array($ress)) {
												...
												<a href="bank_garansi_edit.php?id='. $data['id'] .'" class="btn btn-warning btn-xs">Edit</a>';?>
													  <a href="action/bank_garansi_hapus.php?id=<?php echo $data['id'];?>" onclick="return confirm('Apakah anda yakin akan menghapus <?php echo $data['nama_agen'];?>?');" class="btn btn-danger btn-xs">Hapus</a></td>
												<?php
													  echo '</td>';
												echo '</tr>';												
												$i++;
